...
module.exports = NodeHelper.create({
    ...
    getForecast: function(url) {
        ...
        request({
            ...
            for (i = 0; i < forecast.length; i++) { // loop the array
            ...
            fs.writeFileSync(this.path, JSON.stringify(this.forecast));
            this.sendSocketNotification('FORECAST_RESULT', this.forecast);
